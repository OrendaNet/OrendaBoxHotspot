...
manifest.versions = [{
  ...
  releaseNotes: 'First release: managed WiFi hotspot for OrendaBox. Set the WiFi name and password, optionally share the Box internet connection, and let nearby devices reach Box-hosted web apps. Requires Edge Manager 0.2.44 and platform 0.2.52 or later.'
}];
